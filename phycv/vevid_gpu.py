...
class VEVID_GPU:
    ...
    def load_img(self, img_file=None, img_array=None):
        ...
        if img_array is not None:
        ...
        elif img_file is not None:  # Check if img_file is provided and is not None
            ...
            raise ValueError("Either img_file or img_array should be provided.")
    ...
    def run_lite(self, img_file=None, img_array=None, b=0.16, G=1.4, color=False):
        """run the full VEViD Lite algorithm
